...
exports.update = function(req, res){
    ...
    var Query = conn.query("UPDATE goal g INNER JOIN kids k ON g.pk_goal = k.current_goal AND g.fk_kids = k.pk_kids SET state = ? AND now_cost=(now_cost+?); INSERT INTO saving_list (now_cost, date, fk_kids) values(?,?,?)", [req.body.now_cost, req.body.state,req.body.now_cost,nowDate,req.user.fk_kids], function(err, result){
